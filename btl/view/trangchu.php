    ...
    <section class="main">
                                    ...
                                    <div class="ci-box c1">
                                        <div class="hcp-icon">
                                            <i class="fas icons8-phone">
													<a href="#" title=""> <img src="../public/img/icons8-video-50.png" alt=""> </a>
												</i>
                                        </div>
                                        <strong>
												<a href="#">video</a>
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="card-product">
                                    <div class="ci-box c2">
                                        <div class="hcp-icon">
                                            <i class="fas icons8-phone">
													<a href="#" title=""> <img src="../public/img/icons8-document-64.png" alt=""> </a>
												</i>
                                        </div>
                                        <strong>
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="card-product">
                                    <div class="ci-box c3">
                                        <div class="hcp-icon">
                                            <i class="fas icons8-phone">
													<a href="#" title=""> <img src="../public/img/icons8-attendance-50.png" alt=""> </a>
												</i>
                                        </div>
                                        <strong>
												<a href="#">Điểm danh môn học</a>
											</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="card-product">
                                    <div class="ci-box c3">
                                        <div class="hcp-icon">
                                            <i class="fas icons8-phone">
													<a href="#" title=""> <img src="../public/img/icons8-phone-50.png" alt=""> </a>
												</i>
                                        </div>
                                        <strong>
												<a href="#">Liên hệ : 092388948</a>
											</strong>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="h1-welcome">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="region region-gioi-thieu">
...
>>>>>>> thao
                    ...
                    <div class="col-md-6">
                        <div class="region region-chuyen-nganh">
                            <div id="block-views-new2-block-nganhhoc" class="block block-views">
                                <div class="content">
                                    <div class="view">
...
>>>>>>> dc19335527ce20bf99f4d7be225adadd94edc879
				</div><!-- row -->
			</div><!-- container -->
		</div>
