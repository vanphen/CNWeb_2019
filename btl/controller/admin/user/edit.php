...
$querry2 = "SELECT * FROM users where id=?";
...
$sql ="UPDATE `first_name` SET `last_name` =?,`email`=?, `password` =? WHERE `users`.`id` =$id ;";
          ...
          <div class="row">
            ...
            <div class="col-md-6"> 
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  name="first_name" class="form-control" value="<?php echo $first_name1 ;?>" id="inputEmail3" required placeholder="">
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <input type="text"  name="last_name" class="form-control" value="<?php echo $last_name1; ?>" id="inputEmail3" required placeholder="">
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <input type="email"  name="email" class="form-control"  value="<?php echo $user1; ?>" id="inputEmail3" required placeholder="">
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <input type="text"  name="password" class="form-control" value="<?php echo $pass1; ?>" id="inputEmail3" required placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    <button type="submit" name="sub_mit" class="btn btn-primary">cap nhat</button>
                  </div>
                </div>
              </form>
